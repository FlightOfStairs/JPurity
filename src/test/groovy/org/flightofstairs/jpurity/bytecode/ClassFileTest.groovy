...
class ClassFileTest {
	...
	@Test void testGetCalls_about() {
		Set<Call> calls = [
				...
				new Call(new Method('org/flightofstairs/plaintwitterwidget/About', 'onCreate', '(Landroid/os/Bundle;)V', false, false), new Method('android/content/SharedPreferences', 'registerOnSharedPreferenceChangeListener', '(Landroid/content/SharedPreferences$OnSharedPreferenceChangeListener;)V', false, true)),
	...
	@Test void testGetCalls_attachDialog() {
		Set<Call> calls = [
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'attachButtonActionPerformed', '(Ljava/awt/event/ActionEvent;)V', false, false), new Method('java/util/List', 'get', '(I)Ljava/lang/Object;', false, true)),
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'refreshVMs', '()V', false, false), new Method('java/util/List', 'clear', '()V', false, true)),
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'attachButtonActionPerformed', '(Ljava/awt/event/ActionEvent;)V', false, false), new Method('java/util/List', 'isEmpty', '()Z', false, true)),
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'initComponents', '()V', false, false), new Method('javax/swing/table/TableColumnModel', 'getColumn', '(I)Ljavax/swing/table/TableColumn;', false, true)),
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'getPackages', '()Ljava/util/List;', false, false), new Method('java/util/List', 'add', '(Ljava/lang/Object;)Z', false, true)),
				...
				new Call(new Method('org/flightofstairs/honours/app/dialogs/AttachDialog', 'refreshVMs', '()V', false, false), new Method('java/util/List', 'addAll', '(Ljava/util/Collection;)Z', false, true)),
